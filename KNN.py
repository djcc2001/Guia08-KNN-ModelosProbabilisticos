...
def main():
    ...
    print(f"Prediccion de Peso (Manhattan): {reg_prediction}")
    ...
    # Question :
    # Given the data we have , does a 33 year old like pineapples ontheir pizza ?
    clf_query = [33]
    clf_k_nearest_neighbors, clf_prediction = knn(
        clf_data, clf_query, k=3, distance_fn=minkowski_distance, choice_fn=mode
    )
    print(f"Prediccion de Preferencia de Piña (Minkowski): {clf_prediction}")
